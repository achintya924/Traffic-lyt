...
from app.routers import anomalies, patrol, policy, predict, spatial_aggregations, stats, time_aggregations, warnings, zones, zones_analytics, zones_compare, zones_rankings
